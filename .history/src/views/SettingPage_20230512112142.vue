                    ...
                    <div class="space-y-6 max-w-md">
                        ...
                        <div class="modal">
                            <div class="modal-box bg-black/60 backdrop-blur-lg w-11/12 max-w-lg">
                                ...
                                <Icon v-if="mode == 'finger'" icon="heroicons:finger-print-20-solid" class="text-4xl mr-3 text-primary"/>
                                <Icon v-else icon="tabler:nfc" class="text-4xl mr-3 text-primary"/>
                                ...
                                <div class="modal-action">
                                    <label for="modal-action" class="btn">Cancel</label>
                                </div>
                            </div>
                        </div>
                    </div>
