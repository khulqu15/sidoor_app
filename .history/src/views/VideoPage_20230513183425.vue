<template>
    <ion-page>
        <ion-content>
            <div v-if="!leaving" class="min-h-screen w-full relative overflow-hidden grid grid-cols items-center justify-center">
...
export default {
    ...
    setup() {
        ...
        return { videoEl, canvas, onPlay, onLeaving, leaving, labelDetected, hasDetected, countSuccessed, timer, remainingTime }
    }
}
</script>
