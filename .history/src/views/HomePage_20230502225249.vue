        ...
        <div class="grid grid-cols-1 items-center min-h-screen justify-items-center">
          ...
          <div id="lock-content" class="relative w-1/2 z-30">
            <div id="pin">
              ...
              <div class="w-full bg-black/40 rounded-2xl backdrop-blur mx-auto mt-6 p-8">
                <div class="grid grid-cols-3 items-center justify-items-center">
                  <div><button class="btn bg-black/30 outline-1 outline-white w-20 h-20 rounded-full text-xl">1</button></div>
                  <div><button class="btn bg-black/30 outline-1 outline-white w-20 h-20 rounded-full text-xl">2</button></div>
                  <div><button class="btn bg-black/30 outline-1 outline-white w-20 h-20 rounded-full text-xl">3</button></div>
                </div>
              </div>
            </div>
            <div id="pattern"></div>
