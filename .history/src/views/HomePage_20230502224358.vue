                ...
                <div>
                  ...
                  <div class="w-50">
                    <input 
                      ...
                      maxlength="5"
                      :readonly="true"
                      class="input w-full bg-black/30 mt-6 backdrop-blur border border-white text-white tracking-widest w-44 h-20 text-7xl pb-3"/>
                  </div>
                </div>
              </div>
              <div class="w-full bg-primary/40 mx-auto mt-4 p-8">
