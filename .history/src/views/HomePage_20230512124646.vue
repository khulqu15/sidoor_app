          ...
          <div id="lock-content" class="relative md:w-1/2 sm:w-3/4 z-30 animate__animated animate__fadeInUp">
            ...
            <div v-if="correct" id="success" class="animate__animated animate__fadeIn relative z-30 text-white text-center">
              <div :key="count_success">
                ...
                <div class="radial-progress bg-black/40 transition-all text-primary-content mt-6" :style="{'--value': (mode === 'pin' ? remainingTime : remainingTime1) * (100 / (mode === 'pin' ? remainingTime : remainingTime1)), '--thickness': '2px'}">{{ (mode === 'pin' ? remainingTime : remainingTime1) }} s</div>
                <div class="mt-3">
