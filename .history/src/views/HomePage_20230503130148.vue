        ...
        <div class="grid grid-cols-1 items-center min-h-screen justify-items-center">
          ...
          <div id="lock-content" class="relative md:w-1/2 sm:w-3/4 z-30 animate__animated animate__fadeInUp">
            ...
            <div id="pattern" class="absolute bottom-0 opacity-0 z-10">
              ...
              <div id="patter-canvas" class="w-full bg-black/40 rounded-2xl backdrop-blur mx-auto mt-6 p-8 space-y-6">
                <canvas id="pattern-canvas" width="360" height="360"></canvas>
              </div>
              <div class="mt-12 text-center">
...
export default defineComponent({
  ...
  methods: {
    ...
    initPattern() {
      const context: any | null = document.getElementById('pattern-canvas').getContext('2d')
