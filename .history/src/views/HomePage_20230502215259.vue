    ...
    <ion-content :fullscreen="true">
      <div class="min-h-screen w-full relative">
        ...
        <div class="grid grid-cols-1 items-center min-h-screen justify-items-center">
          <div class="relative z-30 text-white w-3/4 text-center py-12 bg-black/50 rounded-2xl backdrop-blur overflow-hidden">
            <div id="hello" class="animate__animated animate__fadeInDown text-4xl font-bold">Hello, I'm Sidoor</div>
            <div id="smart_door" class="animate__animated text-4xl font-bold hidden">Smart Door</div>
          </div>
        </div>
      </div>
    </ion-content>
...
export default defineComponent({
  ...
  methods: {
    runLoading() {
      ...
      setTimeout(() => {
        smart_door?.classList.remove('animate__animated', 'animate__fadeInDown')
        smart_door?.classList.add('animate__animated', 'animate__fadeOutDown')
      }, 1000);
    }
  }
})
