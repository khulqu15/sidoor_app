  ...
  <ion-page>
    <ion-content :fullscreen="true">
      <div class="min-h-screen w-full relative">
        <div class="absolute w-full h-full z-20 bg-black/50"></div>
        ...
        <div class="grid grid-cols-1 items-center min-h-screen justify-items-center">
          <div class="relative z-30 text-white w-3/4 text-center py-12 bg-black/50 transition-all rounded-2xl backdrop-blur overflow-hidden">
            <div id="hello" class="absolute top-0 animate__animated animate__fadeInDown text-4xl font-bold">Hello, I'm Sidoor</div>
            <div id="smart_door" class="absolute top-0 text-2xl font-bold hidden">Secure your home door with our advanced technology</div>
          </div>
        </div>
      </div>
    </ion-content>
