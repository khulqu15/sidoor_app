    ...
    <ion-content :fullscreen="true">
      <div class="min-h-screen w-full relative">
        ...
        <div class="grid grid-cols-1 items-center min-h-screen justify-items-center">
          ...
          <div id="lock-content" class="relative hidden md:w-1/2 sm:w-3/4 z-30 animate__animated animate__fadeInUp">
            <div id="pin">
            ...
            <div id="pattern"></div>
            <div id="success" class="relative z-30 text-white">
              Hallo
              <Icon icon="solar:shield-check-bold-duotone" class="text-white"/>
            </div>
          </div>
        </div>
      </div>
