            ...
            <div id="pin">
              ...
              <div class="w-full bg-black/40 rounded-2xl backdrop-blur mx-auto mt-6 p-8">
                <div class="grid grid-cols-3 items-center justify-items-center">
                  <div><button class="btn btn-ghost w-20 h-20 rounded-full text-xl">1</button></div>
                  <div><button class="btn btn-ghost w-20 h-20 rounded-full text-xl">2</button></div>
                  <div><button class="btn btn-ghost w-20 h-20 rounded-full text-xl">3</button></div>
                </div>
              </div>
            </div>
            <div id="pattern"></div>
