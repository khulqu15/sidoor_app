  ...
  methods: {
    ...
    changeMode(value: string) {
      ...
      if(value == 'pattern') {
        ...
        setTimeout(() => {
          pin_content?.classList.add('hidden')
          pattern_content?.classList.remove('absolute', 'bottom-0', 'opacity-0')
        ...
        setTimeout(() => {
          ...
          pin_content?.classList.remove('absolute', 'bottom-0', 'opacity-0', 'animate__animated', 'hidden', 'animate__fadeOutDown')
